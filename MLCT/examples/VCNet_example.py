...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='vcnet', help='model to use,["nn", "drnet", "vcnet"]')
    ...
    parser.add_argument('--knots', type=list, default=[0.33, 0.66], help="the number of samples for training")
